...
@section('content')
        ...
        @endif
            ...
            <form action="{{ url('/admin/rate/edit-rate/'. $rateDetails->id) }}" method="POST" enctype = "multipart/form-data" novalidate="novalidate">
                {{ csrf_field() }}
            ...
            <div class="card-body  table-responsive ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="rate_id_package" class="form-control">
                            <option value="4" @if($rateDetails->id_package == 4) selected="selected" @endif>2 nights</option>
                            <option value="3" @if($rateDetails->id_package == 3) selected="selected" @endif>Mid-week</option>
                            <option value="2" @if($rateDetails->id_package == 2) selected="selected" @endif>Night</option>
                            <option value="6" @if($rateDetails->id_package == 6) selected="selected" @endif>Week</option>
                            <option value="1" @if($rateDetails->id_package == 1) selected="selected" @endif>Week-end</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                    <input type="text" name="rate_price" id="rate_price_0_0"  rel="rate_price_0" class="form-control" value="{{$rateDetails->price}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="rate_people" id="rate_people_0_0"  rel="rate_people_0" class="form-control" value="{{$rateDetails->people}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="rate_discount" id="rate_discount_0_0"  rel="rate_discount_0" class="form-control" value="{{$rateDetails->discount}}">
                    </div>
                </div>
